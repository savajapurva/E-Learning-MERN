...
export default class Upload extends Component {
  ...
  componentDidMount() {
  axios.get('http://localhost:5000/coursebyinstructor?id='+this.props.match.params.id)
  .then(response => {
...
onChangeHandler=event=>{
  ...
  onClickHandler = () => {
    ...
    console.log(data);
    axios.post("http://localhost:5000/lectures/localupload", data, {
      ...
      <div class="container">
          ...
          <form action="lectures/localupload"  method="POST" encType="multipart/form-data">
               ...
               <label>Course Name </label>
                            <select 
                            className="form-control" name="course"
                            id="ada"
